...
Write the name of the service your group has decided to use: For communications we chose GroupMe.  Organized through github.
...
3. List the names of your group members here:Nikhil Mohanty, Christine Hyesoo

4. Copy and paste the URL for your group’s GitHub organization here:https://github.com/orgs/iititmd362
...
Write the URL for your personal fork of the repository here:https://github.com/trevhead0/project2-3
...
Used upstream as remote name.
origin	git@github.com:trevhead0/project2-3.git (fetch)
origin	git@github.com:trevhead0/project2-3.git (push)
upstream	git@github.com:iititmd362/project2-3.git (fetch)
upstream	git@github.com:iititmd362/project2-3.git (push)
...
Write the URL of your pull request here:https://github.com/iititmd362/project2-3/pull/1
